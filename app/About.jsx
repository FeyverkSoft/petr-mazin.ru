...
А ещё увлекаюсь Front end технологиями и микроконтроллерами. (Если точнее esp8266) 
Под микрики пишу на C++ 11 (platformio).

В этом бложике будут публиковаться разные статейки, заметки, скрипты, и иного рода интересный для меня контент.
Возможно отчёты о проделанной работе или что-то ещё.

Посмотреть скрипты вы всегда сможете в разделе !:/scripts:скриптов:!, а новости и заметки  !:./:тут:!,

__Технологии:__
|(center) Программирование |(center) Языки разметки, формат обмена |(center) Web библиотеки, фреймворки, cms |
| C#, ~~JavaScript~~, TypeScript, Java | HTML, LESS, CSS, XML, JSON | jQuery, Bootstrap 3, React Js, AKKA (C#), Vue.JS |

PS: Возможно тут будет ещё и портфолио, но как-то лень... Бугага.
